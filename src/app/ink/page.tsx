				  ...
				  <div className={styles.droppage}>
					  <div className={styles.dropdata}>
						  ...
						  <div className={styles.dropsocial}>
							  ...
							  <Link href="https://t.me/inkonchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/tel.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://github.com/inkonchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/gi.png"
									  width={40}
									  height={40}
