...
const GaslessHome: React.FC = () => {
	...
	return (
		<div className={styles.container}>
			...
			<p className={styles.faucettitle}>Plume Network</p>
			<br />
			
			<a
				className="gradientText2"
				target="_blank"
				href="https://faucet.plumenetwork.xyz/"
			>
			Faucet
			</a>
			<br />
...
const ClaimButton: React.FC<WalletAddressProps> = ({WalletAddress}) => {
	...
	const ERC721 = getContract({
		client: client,
		chain:  defineChain(161221135),
		address: "0xf3568DcbaC977a578F7B643D1dA1BFE686286525",
	});
	const ERC1155 = getContract({
		client: client,
		chain:  defineChain(161221135),
		address: "0x611338e6aCCF12a5aF61A4C0d8e290dA010b1232",
	});
	const ERC20 = getContract({
		client: client,
		chain:  defineChain(161221135),
		address: "0xe09d22e2AEFA8f43cE7aE75d4C5Dc0541560301D",
	});
