				  ...
				  <div className={styles.droppage}>
					  <div className={styles.dropdata}>
						  ...
						  <div className={styles.dropsocial}>
							  ...
							  <Link href="https://www.mintchain.io/" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/we.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://x.com/Mint_Blockchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/tw.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://discord.com/invite/mint-blockchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/dis.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://t.me/MintBlockchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/tel.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://github.com/Mint-Blockchain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/gi.png"
									  width={40}
									  height={40}
