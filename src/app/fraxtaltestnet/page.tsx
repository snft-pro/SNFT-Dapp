...
const GaslessHome: React.FC = () => {
	...
	return (
		<div className={styles.container}>
			...
			<p className={styles.faucettitle}>Fraxtal Testnet</p>
			<br />
			
			<a
				className="gradientText2"
				target="_blank"
				href="https://testnet.frax.com/tools/bridge/deposit"
			>
			Bridge
			</a>
...
const ClaimButton: React.FC<WalletAddressProps> = ({WalletAddress}) => {
	...
	const ERC721 = getContract({
		client: client,
		chain:  defineChain(2522),
		address: "0xD5D8B729e186b0AA09e1Fd27cCd6516C6abe4030",
	});
	const ERC1155 = getContract({
		client: client,
		chain:  defineChain(2522),
		address: "0xE99e5eE16E5a232bEcaF60b5E044ca1c3977c715",
	});
	const ERC20 = getContract({
		client: client,
		chain:  defineChain(2522),
		address: "0x3D33DE7f2f828C56C7fb05b51468716991B05A87",
	});
