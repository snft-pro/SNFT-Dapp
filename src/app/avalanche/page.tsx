				  ...
				  <div className={styles.droppage}>
					  ...
					  <div className={styles.dropmintcard}>
						  ...
						  <MediaRenderer 
							  ...
							  style={{ width: "220px", height: "250px", border: "1px solid #18191e",  borderRadius: "20px",  backgroundColor: "#18191e"}}
						  />
						  <br />
				       ...
				       style={{width: "300px", height: "50px", backgroundColor:"#18191e", border: "1px solid #9693972a", color: "#ffffff"}}
						  ...
						  >
							  ...
							  {`Claim NFT (${getPrice(quantity)} AVAX)`}
						  </TransactionButton>
