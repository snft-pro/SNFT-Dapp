				  ...
				  <div className={styles.droppage}>
					  ...
					  <div className={styles.dropmintcard}>
						  ...
						  <MediaRenderer 
							  ...
							  style={{ width: "210px", height: "260px", border: "1px solid #18191e",  borderRadius: "20px",  backgroundColor: "#18191e"}}
						  />
						  <br />
						  ...
						  >
							  ...
							  {`Claim NFT (${getPrice(quantity)} KLAY)`}
						  </TransactionButton>
