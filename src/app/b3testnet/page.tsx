	...
	return (
		<div className={styles.container}>
				<div className={styles.faucetpage}>
					<p className={styles.erc20staketitle}>B3 Sepolia</p>
					<br />
			<a
				className="gradientText2"
				target="_blank"
				href="https://faucet.b3.fun"
			>
				Faucet
			</a>
			<br />
...
const ClaimButton: React.FC<WalletAddressProps> = ({WalletAddress}) => {
	...
	const ERC721 = getContract({
		...
		address: "0x7f9640551717014fDd1C7FDd9F0d15B5a407a09C",
	});
	const ERC1155 = getContract({
		client: client,
		chain:  defineChain(1993),
		address: "0x9D4B2a883d58B7fB5E5647883f96179E56ba1f7c",
	});
	const ERC20 = getContract({
		client: client,
		chain:  defineChain(1993),
		address: "0xfb289703aa98976a741D26993d9AfDb0391d3e43",
	});
	return (
