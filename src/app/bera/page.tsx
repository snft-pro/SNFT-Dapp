...
import { Bera } from "@/consts/chains";
				  ...
				  <div className={styles.droppage}>
					  <div className={styles.dropdata}>
						  ...
						  <div className={styles.dropsocial}>
							  ...
							  <Link href="https://discord.com/invite/berachain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/dis.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://t.me/BerachainPortal" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/tel.png"
									  width={40}
									  height={40}
							  ...
							  <Link href="https://github.com/berachain" className={`${styles.homeLink} ${styles.navLeft}`} target="_blank" rel="noreferrer">
								  <Image
									  src="/icons/gi.png"
									  width={40}
									  height={40}
