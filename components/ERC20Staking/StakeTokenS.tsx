...
import { REWARD_ERC20_TOKEN_CONTRACT, STAKE_ERC20_TOKEN_CONTRACT, STAKING_ERC20_CONTRACT } from  "@/../utils/s-staking";
...
export const StakeToken = () => {
    ...
    return (
        <div className={styles.erc20stakepeage}>
            <p className={styles.erc20staketitle}>S Staking</p>
            <p className={styles.erc20stakedescription}> Stake S tokens, earn SP tokens, 25% APY</p>
            {account && (
                    ...
                    {stakeInfo && (
                        <>
                            ...
                            <div className={styles.erc20stakebtn}>
                                <p className={styles.erc20stakedescription}>S Staked: {truncate(toEther(stakeInfo[0]).toString(),8)}</p>
