...
import { REWARD_TOKEN_CONTRACT, STAKING_CONTRACT } from  "@/../utils/passstakewm";
    ...
    return (
        <Box >
            ...
            {!isTokenBalanceLoading && tokenBalance && (
                <p className={styles.deopdescription}>Wallet Balance: {toEther(BigInt(tokenBalance.toString()))} wMATIC</p>
            )}
