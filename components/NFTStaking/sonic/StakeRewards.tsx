...
import { REWARD_TOKEN_CONTRACT, STAKING_CONTRACT } from  "@/../utils/sonicstakes";
    ...
    return (
        <Box >
            ...
            {!isTokenBalanceLoading && tokenBalance && (
                <p className={styles.deopdescription}>wS Balance: {toEther(BigInt(tokenBalance.toString()))} </p>
            )}
